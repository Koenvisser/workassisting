...
plot './results/Sum_function_n___263,378.dat' using 1:2 title "Rayon" pointsize 0.7 lw 1 pt 1 linecolor rgb "#6E3B23" with linespoints, \
  ...
  './results/Sum_function_n___263,378.dat' using 1:7 title "Multi-atomics 32 1 1" pointsize 0.7 lw 2 pt 1 linecolor rgb "#40141E" with linespoints, \
  './results/Sum_function_n___263,378.dat' using 1:8 title "Multi-atomics 64 10 1" pointsize 0.7 lw 2 pt 1 linecolor rgb "#80C81E" with linespoints, \
  './results/Sum_function_n___263,378.dat' using 1:9 title "Multi-atomics 64 1 4" pointsize 0.7 lw 2 pt 1 linecolor rgb "#801478" with linespoints, \
  './results/Sum_function_n___263,378.dat' using 1:10 title "Multi-atomics 64 10 4" pointsize 0.7 lw 2 pt 1 linecolor rgb "#80C878" with linespoints, \
  './results/Sum_function_n___263,378.dat' using 1:11 title "Work assisting" pointsize 0.4 lw 2 pt 7 linecolor rgb "#C00A35" with linespoints
