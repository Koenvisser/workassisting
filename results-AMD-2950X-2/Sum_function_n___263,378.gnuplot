...
plot './results/Sum_function_n___263,378.dat' using 1:2 title "Rayon" pointsize 0.7 lw 1 pt 1 linecolor rgb "#6E3B23" with linespoints, \
  ...
  './results/Sum_function_n___263,378.dat' using 1:8 title "Multi-atomics 64 1 4" pointsize 0.7 lw 2 pt 1 linecolor rgb "#801478" with linespoints, \
  './results/Sum_function_n___263,378.dat' using 1:9 title "WorkAssisting 1" pointsize 0.4 lw 2 pt 7 linecolor rgb "#320A35" with linespoints, \
  './results/Sum_function_n___263,378.dat' using 1:10 title "WorkAssisting 4" pointsize 0.4 lw 2 pt 7 linecolor rgb "#C80A35" with linespoints
