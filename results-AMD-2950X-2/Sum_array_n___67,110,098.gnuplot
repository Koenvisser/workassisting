...
plot './results/Sum_array_n___67,110,098.dat' using 1:2 title "Rayon" pointsize 0.7 lw 1 pt 1 linecolor rgb "#6E3B23" with linespoints, \
  ...
  './results/Sum_array_n___67,110,098.dat' using 1:8 title "Multi-atomics 64 1 32" pointsize 0.7 lw 2 pt 1 linecolor rgb "#8014C0" with linespoints, \
  './results/Sum_array_n___67,110,098.dat' using 1:9 title "WorkAssisting 1" pointsize 0.4 lw 2 pt 7 linecolor rgb "#070A35" with linespoints, \
  './results/Sum_array_n___67,110,098.dat' using 1:10 title "WorkAssisting 32" pointsize 0.4 lw 2 pt 7 linecolor rgb "#E00A35" with linespoints
