...
plot './results/Sort_n___1,048,576.dat' using 1:2 title "Sequential partition" pointsize 0.7 lw 1 pt 1 linecolor rgb "#24A793" with linespoints, \
  ...
  './results/Sort_n___1,048,576.dat' using 1:6 title "Multi-atomics 64 1 4" pointsize 0.7 lw 2 pt 1 linecolor rgb "#801478" with linespoints, \
  './results/Sort_n___1,048,576.dat' using 1:7 title "WorkAssisting 1" pointsize 0.4 lw 2 pt 7 linecolor rgb "#320A35" with linespoints, \
  './results/Sort_n___1,048,576.dat' using 1:8 title "WorkAssisting 4" pointsize 0.4 lw 2 pt 7 linecolor rgb "#C80A35" with linespoints
