...
plot './results/Primes_2_.._1,048,578.dat' using 1:2 title "Rayon" pointsize 0.7 lw 1 pt 1 linecolor rgb "#6E3B23" with linespoints, \
  ...
  './results/Primes_2_.._1,048,578.dat' using 1:6 title "Multi-atomics 64 1 4" pointsize 0.7 lw 2 pt 1 linecolor rgb "#801478" with linespoints, \
  './results/Primes_2_.._1,048,578.dat' using 1:7 title "Multi-atomics 2 64 1 4" pointsize 0.7 lw 2 pt 1 linecolor rgb "#0A5080" with linespoints, \
  './results/Primes_2_.._1,048,578.dat' using 1:8 title "Multi-atomics 3 64 1 4" pointsize 0.7 lw 2 pt 1 linecolor rgb "#281480" with linespoints, \
  './results/Primes_2_.._1,048,578.dat' using 1:9 title "WorkAssisting 4" pointsize 0.4 lw 2 pt 7 linecolor rgb "#C80A35" with linespoints
