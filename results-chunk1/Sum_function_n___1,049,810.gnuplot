...
plot './results/Sum_function_n___1,049,810.dat' using 1:2 title "Rayon" pointsize 0.7 lw 1 pt 1 linecolor rgb "#6E3B23" with linespoints, \
  ...
  './results/Sum_function_n___1,049,810.dat' using 1:6 title "Sharded SS 1" pointsize 0.7 lw 2 pt 1 linecolor rgb "#80D000" with linespoints, \
  './results/Sum_function_n___1,049,810.dat' using 1:7 title "WorkAssisting 1" pointsize 0.4 lw 2 pt 7 linecolor rgb "#F40A35" with linespoints
