...
plot './results/Primes_2_.._1,048,578.dat' using 1:2 title "Rayon" pointsize 0.7 lw 1 pt 1 linecolor rgb "#6E3B23" with linespoints, \
  ...
  './results/Primes_2_.._1,048,578.dat' using 1:6 title "Multi-atomics 64" pointsize 0.7 lw 2 pt 1 linecolor rgb "#64D000" with linespoints, \
  './results/Primes_2_.._1,048,578.dat' using 1:7 title "WorkAssisting" pointsize 0.4 lw 2 pt 7 linecolor rgb "#F40A35" with linespoints
