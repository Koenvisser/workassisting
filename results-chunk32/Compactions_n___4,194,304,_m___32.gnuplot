...
plot './results/Compactions_n___4,194,304,_m___32.dat' using 1:2 title "Outer parallelism" pointsize 0.7 lw 1 pt 1 linecolor rgb "#24A793" with linespoints, \
  ...
  './results/Compactions_n___4,194,304,_m___32.dat' using 1:4 title "Multi-atomics 64 32" pointsize 0.7 lw 2 pt 1 linecolor rgb "#64D000" with linespoints, \
  './results/Compactions_n___4,194,304,_m___32.dat' using 1:5 title "WorkAssisting 32" pointsize 0.4 lw 2 pt 7 linecolor rgb "#800A35" with linespoints
