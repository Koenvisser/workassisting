...
plot './results/Sum_array_n___67,110,098.dat' using 1:2 title "Rayon" pointsize 0.7 lw 1 pt 1 linecolor rgb "#6E3B23" with linespoints, \
  ...
  './results/Sum_array_n___67,110,098.dat' using 1:6 title "Multi-atomics 64 32" pointsize 0.7 lw 2 pt 1 linecolor rgb "#64D000" with linespoints, \
  './results/Sum_array_n___67,110,098.dat' using 1:7 title "WorkAssisting 32" pointsize 0.4 lw 2 pt 7 linecolor rgb "#800A35" with linespoints
