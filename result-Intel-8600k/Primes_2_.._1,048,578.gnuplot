...
plot './results/Primes_2_.._1,048,578.dat' using 1:2 title "Rayon" pointsize 0.7 lw 1 pt 1 linecolor rgb "#6E3B23" with linespoints, \
  ...
  './results/Primes_2_.._1,048,578.dat' using 1:9 title "Multi-atomics" pointsize 0.7 lw 2 pt 1 linecolor rgb "#A7E310" with linespoints, \
  './results/Primes_2_.._1,048,578.dat' using 1:10 title "Work assisting" pointsize 0.4 lw 2 pt 7 linecolor rgb "#C00A35" with linespoints
