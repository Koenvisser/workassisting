...
plot './results/LUD_n___512,_m___8.dat' using 1:2 title "Work stealing" pointsize 0.7 lw 1 pt 6 linecolor rgb "#5B2182" with linespoints, \
  ...
  './results/LUD_n___512,_m___8.dat' using 1:5 title "Multi-atomics" pointsize 0.7 lw 2 pt 1 linecolor rgb "#A7E310" with linespoints, \
  './results/LUD_n___512,_m___8.dat' using 1:6 title "Work assisting" pointsize 0.4 lw 2 pt 7 linecolor rgb "#C00A35" with linespoints
